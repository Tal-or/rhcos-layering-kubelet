...
# from the cluster
REGISTRY_IMAGE=quay.io/titzhak/test-build:rhcos-layer-2

#
# Configure the MachineConfig label needed to targed the proper
# MachineConfigPool
MCLABEL="machineconfiguration.openshift.io/role: worker"
...
FROM="quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:71a177fcc36bd91e20ac0414b081016a3f592387f57b4f39738928ea5046aed4"
